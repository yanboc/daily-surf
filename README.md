...
> 个人科研 / 技术资讯流：每天自动抓取论文、GitHub、大厂博客、大佬动态，生成日报/周报并邮件推送。
> 本文件是索引入口，具体内容见下方导航。
...
| 分类 | 位置 | 说明 |
| --- | --- | --- |
| 偏好 / taste | [`.preference/`](.preference/) | 论文 [`papers.md`](.preference/papers.md) · 代码仓 `repos.md` · 博客 `blogs.md` · 大佬 `people.md` · 反馈 `feedback/` |
